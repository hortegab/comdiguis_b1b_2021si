...
from b_USRP_Sink_simul_f import b_USRP_Sink_simul_f  # grc-generated hier_block
...
class sistemabase(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.Tablav = Tablav = digital.constellation_16qam().points()
        self.M = M = len(Tablav)
        ...
        self.qtgui_time_sink_x_0_1 = qtgui.time_sink_f(
            int(6*((Fc+samp_rate/2)*8)/samp_rate), #size
            (Fc+samp_rate/2)*8, #samp_rate
            "senal RF", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.Menu_grid_layout_5.addWidget(self._qtgui_time_sink_x_0_1_win, 0, 0, 1, 1)
        for r in range(0, 1):
        ...
        self.b_USRP_Sink_simul_f_0 = b_USRP_Sink_simul_f(
        ...
        self.connect((self.b_USRP_Sink_simul_f_0, 0), (self.qtgui_time_sink_x_0_1, 0))
        ...
        self.connect((self.interp_fir_filter_xxx_0, 0), (self.b_USRP_Sink_simul_f_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.b_USRP_Sink_simul_f_0.set_Bandwidth(self.samp_rate/2)
        self.b_USRP_Sink_simul_f_0.set_Samp_Rate(self.samp_rate)
        self.qtgui_eye_sink_x_0.set_samp_rate(self.samp_rate)
        self.qtgui_eye_sink_x_0_0.set_samp_rate(self.samp_rate)
        self.qtgui_freq_sink_x_0.set_frequency_range(0, self.samp_rate)
        self.qtgui_time_sink_x_0_0.set_samp_rate(self.samp_rate)
        self.qtgui_time_sink_x_0_1.set_samp_rate((self.Fc+self.samp_rate/2)*8)
    ...
    def set_Fc(self, Fc):
        self.Fc = Fc
        self.b_USRP_Sink_simul_f_0.set_Center_Freq(self.Fc)
        self.qtgui_time_sink_x_0_1.set_samp_rate((self.Fc+self.samp_rate/2)*8)
