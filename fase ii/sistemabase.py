...
import sip
from b_VCO_2021si_fc import b_VCO_2021si_fc  # grc-generated hier_block
...
class sistemabase(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.fd = fd = 2*Rs
        self.Kf = Kf = fd/Rs
        self.Sps = Sps = int(16*(M-1)*Kf)
        self.samp_rate = samp_rate = Rs*Sps
        self.h0 = h0 = ([1]*Sps)
        self.Tp = Tp = int(Sps/(Kf*4))
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(fd)
        self.blocks_char_to_float_0 = blocks.char_to_float(1, 1)
        self.blocks_add_xx_0 = blocks.add_vcc(1)
        self.blocks_add_const_vxx_0 = blocks.add_const_ff(-(M-1)/2)
        ...
        self.b_VCO_2021si_fc_0 = b_VCO_2021si_fc(
            Sps=Sps,
            samp_rate=samp_rate,
        )
        ...
        self.connect((self.b_VCO_2021si_fc_0, 0), (self.b_upconverter_cf_0, 0))
        self.connect((self.b_VCO_2021si_fc_0, 0), (self.blocks_add_xx_0, 0))
        self.connect((self.b_VCO_2021si_fc_0, 0), (self.qtgui_const_sink_x_0_0, 0))
        self.connect((self.b_VCO_2021si_fc_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.b_VCO_2021si_fc_0, 0), (self.qtgui_time_sink_x_0_0, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.b_VCO_2021si_fc_0, 0))
    ...
    def set_M(self, M):
        self.M = M
        self.set_Sps(int(16*(self.M-1)*self.Kf))
        self.b_u_M_PAM_bb_0.set_M(self.M)
        self.blocks_add_const_vxx_0.set_k(-(self.M-1)/2)
    ...
    def set_fd(self, fd):
        self.fd = fd
        self.set_Fc(self.fd*4)
        self.set_Kf(self.fd/self.Rs)
        self.blocks_multiply_const_vxx_0.set_k(self.fd)
    ...
    def set_Kf(self, Kf):
        self.Kf = Kf
        self.set_Sps(int(16*(self.M-1)*self.Kf))
        self.set_Tp(int(self.Sps/(self.Kf*4)))
    ...
    def set_Sps(self, Sps):
        ...
        self.set_samp_rate(self.Rs*self.Sps)
        self.b_VCO_2021si_fc_0.set_Sps(self.Sps)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.b_VCO_2021si_fc_0.set_samp_rate(self.samp_rate)
