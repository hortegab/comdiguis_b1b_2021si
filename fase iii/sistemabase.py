...
class sistemabase(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.Tablav = Tablav = digital.constellation_qpsk().points()
        self.M = M = len(Tablav)
        ...
        self.top_grid_layout.addWidget(self._f_d_win, 4, 0, 1, 1)
        for r in range(4, 5):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.Menu.addTab(self.Menu_widget_0, 'T-2 R-2')
        ...
        self.top_grid_layout.addWidget(self.Menu, 5, 0, 1, 1)
        for r in range(5, 6):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        labels = ['T-2', 'R-2', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.Menu_grid_layout_0.addWidget(self._qtgui_time_sink_x_1_0_win, 0, 0, 1, 1)
        for r in range(0, 1):
        ...
        self.Menu_grid_layout_3.addWidget(self._qtgui_time_sink_x_1_win, 0, 0, 1, 1)
        for r in range(0, 1):
        ...
        self.blocks_delay_1_0 = blocks.delay(gr.sizeof_float*1, int(sym_delay*bps))
        ...
        self.analog_const_source_x_0 = analog.sig_source_c(0, analog.GR_CONST_WAVE, 0, 0, np.exp(math.pi/4*1j))
        ...
        self.connect((self.b_diez_cc_0, 0), (self.b_FLL_tunner2_0, 0))
        ...
        self.connect((self.blocks_multiply_xx_0, 0), (self.interp_fir_filter_xxx_0_0, 0))
        self.connect((self.blocks_multiply_xx_0, 0), (self.qtgui_const_sink_x_0_0, 0))
        self.connect((self.blocks_multiply_xx_0, 0), (self.qtgui_eye_sink_x_0_0, 0))
        self.connect((self.blocks_multiply_xx_0, 0), (self.qtgui_freq_sink_x_0, 1))
        self.connect((self.blocks_multiply_xx_0, 0), (self.qtgui_time_sink_x_0_0, 1))
    ...
    def set_Tablav(self, Tablav):
        ...
        self.b_FLL_tunner2_0.set_Constellation(self.Tablav)
    ...
    def set_bps(self, bps):
        ...
        self.blocks_delay_1_0.set_dly(int(self.sym_delay*self.bps))
    ...
    def set_Rb(self, Rb):
        self.Rb = Rb
        self.set_Rs(self.Rb/self.bps)
        self.qtgui_time_sink_x_1_0.set_samp_rate(self.Rb)
